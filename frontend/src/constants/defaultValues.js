export default {
	...
	DEFAULT_BRIGHTEYES_INFO: [
		...
		},
		{
			...
			"description": "How Does BrightEyes.com Work?"
		},
		{
			"id": 8,
		...
		{
			"id": 4,
			"name": "the_brighteyes_difference",
			...
			"description": "The BrightEyes.com Difference"
		},
		{
			"id": 1,
			"name": "what_is_brighteyes",
			"value": "<p>BrightEyes.com is a community of Talent with one common goal: to work on a cruise ship.</p>\r\n<p>With BrightEyes.com, singers, dancers, aerialist, musicians, technicians, activity staff and youth staff can audition and interview with <b>every</b> cruise line <b>at the same time</b> in one easy setp. No need to go to endless auditions. ...</p>",
			"description": "What is BrightEyes.com"
		},
		{
			"id": 3,
			"name": "why_use_brighteyes",
			...
			"description": "Why use BrightEyes.com"
		}
	]
};
