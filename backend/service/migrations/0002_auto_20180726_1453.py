...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='service',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='UAH', max_digits=14),
        ),
        migrations.AlterField(
            model_name='service',
            name='price_currency',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='services', to='service_category.ServiceCategory'),
        ),
    ]
