...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, username, email, password, first_name='admin', last_name='admin'):
        """
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    service = models.ForeignKey(Service, related_name='users', on_delete=models.SET_DEFAULT, null=True, blank=True, default=None)
    phone_number = models.CharField(max_length=50, unique=False, default='')
    ...
    def url(self):
        if self.externalURL:
            ...
            return os.path.join('/', settings.MEDIA_URL, 'user/', os.path.basename(str(self.image)))
